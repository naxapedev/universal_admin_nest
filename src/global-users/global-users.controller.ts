...
import { AssignVisaDto } from './dto/assign-visa.dto';
...
export class GlobalUsersController {
  ...
  @Patch(':globalUserId/assign-company')
  async assignUserToCompany(
    @Param('globalUserId') globalUserId: string,
    @Body() dto: AssignUserToCompanyDto,
  ) {
    return this.globalUsersService.assignUserToCompany(globalUserId, dto.companyId);
  }

  @Patch(':globalUserId/visas')
  async updateUserVisa(
    @Param('globalUserId') globalUserId: string,
    @Body() dto: AssignVisaDto,
  ) {
    return this.globalUsersService.updateUserVisa(globalUserId, dto.productId, dto.role);
  }
}
