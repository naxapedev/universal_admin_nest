...
<html>
  ...
  async sendPasswordResetEmail(email: string, token: string): Promise<void> {
    const frontendUrl = process.env.DEFAULT_FRONTEND_URL || 'http://localhost:5173';
...
<html>
  ...
  <body style="font-family: Arial, sans-serif; background-color: #f9fafb; padding: 20px 0; margin: 0;">
    <div style="max-width: 600px; margin: 20px auto; background: white; padding: 40px 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1); text-align: center;">
      <h2 style="color: #333; font-size: 32px; font-weight: 500; margin: 0 0 20px 0;">Reset Your Password</h2>
      <p style="font-size: 16px; color: #666; font-weight: 400; margin: 0 0 30px 0;">Please click the link below to reset your password. This link is valid for 1 hour.</p>
      <a href="${link}" style="background-color: #2563eb; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-size: 16px; font-weight: 600; display: inline-block;">Reset Password</a>
      <p style="font-size: 12px; color: #999; line-height: 1.6; margin: 30px 0 0 0;">
        If you didn't request this, you can safely ignore this email.
      </p>
      <p style="font-size: 12px; color: #666; line-height: 1.6; margin: 10px 0 0 0;">© 2026 Universal Admin</p>
    </div>
  </body>
</html>`,
    };
